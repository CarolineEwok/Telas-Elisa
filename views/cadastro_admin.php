    ...
    <div class="ui inverted vertical masthead center aligned segment tela-cadastro-admin" >
        ...
        <div class="ui text container form-sobre-fotos" >
            <div class="ui text container centered aligned">
                <h1><label><font color="white" style="margin-right: 60px;"> Cadastro de Administrador</font> </h1>
            </div><br>

            <!--formulario de cadastro -->
            <form class="ui form" action="../controllers/usuario_controller.php?acao=salvar" method="post">
